      ...
      <main className="mx-auto max-w-6xl px-4 pt-24 pb-12">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-muted-foreground">
            Carga y envia recetas medicas con cobro automatico via MercadoPago.
          </p>
        </div>

        {/* Features Quick */}
        <div className="mb-10 grid gap-4 sm:grid-cols-3">
          <div className="flex items-start gap-3 rounded-lg border border-border bg-card p-4 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-primary/10">
              <Zap className="h-4 w-4 text-primary" />
            </div>
            <div>
              <h3 className="font-medium text-card-foreground">Flujo Automatico</h3>
          ...
          <div className="flex items-start gap-3 rounded-lg border border-border bg-card p-4 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md">
            ...
            <div>
              ...
              <p className="mt-0.5 text-sm text-muted-foreground">
                La receta solo se envia despues del pago
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3 rounded-lg border border-border bg-card p-4 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md">
            ...
            <div>
              ...
              <p className="mt-0.5 text-sm text-muted-foreground">
                Comunicacion directa con tus pacientes
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-5">
          ...
          <div className="lg:col-span-3">
            <div className="rounded-xl border border-border bg-card p-6 shadow-sm transition-shadow duration-300 hover:shadow-md">
        ...
        <div className="mt-8 rounded-xl border border-dashed border-primary/30 bg-primary/5 p-6">
          <h4 className="font-semibold text-foreground">Como funciona el flujo</h4>
          <ol className="mt-3 space-y-2 text-sm text-muted-foreground">
            <li className="flex gap-3">
              ...
              <span>Cargas el PDF de la receta autorizada por el Ministerio de Salud</span>
            </li>
            <li className="flex gap-3">
              ...
              <span>Ingresas el numero de WhatsApp del paciente y el monto a cobrar</span>
            </li>
            <li className="flex gap-3">
              ...
              <span>Se envia automaticamente un link de pago de MercadoPago al paciente</span>
            </li>
            <li className="flex gap-3">
              ...
              <span>Cuando el paciente paga, MercadoPago nos notifica (webhook) y la receta se envia automaticamente por WhatsApp</span>
            </li>
          </ol>
        </div>
        ...
        <div className="mt-6 rounded-lg bg-muted p-4 text-center text-sm text-muted-foreground">
          Esta es una version de demostracion (mock). Las integraciones con MercadoPago y WhatsApp estan simuladas.
        </div>
      </main>
    </div>
  )
